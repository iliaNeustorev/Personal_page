...
return [
    ...
    'attributes' => [
        ...
        'teaching_category' => 'Категория',
        'personal_slogan' => 'Персональный слоган',
        'credo' => 'Кредо',
        'personal_email_teacher' => 'Персональный email для связи',
        'kindergarten_in_place_work' => 'Текущее место работы',
        'address_kindergarten' => 'Адрес детского сада',
